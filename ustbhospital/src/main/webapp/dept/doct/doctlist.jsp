        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                ...
                <if condition="$iscid eq 1">
                    <li> <a class="button border-main icon-plus-square-o" href="/pft/list"> 添加内容</a> </li>
                    <li>
...
<%--                            <option value="">请选择科室</option>--%>
                ...
                <li>
                    <input type="text" placeholder="请输入搜索姓名" name="name" class="input" style="width:250px; line-height:17px;display:inline-block" />
...
<script type="text/javascript">
    //发送ajax请求 Doct/list
    //页面加载完成之后调用的函数
    function initDoclist(p,name,jobNumber,deptId){
        $.ajax({
            type: "GET",
            url: "/Doct/list",
            data: {"pageNum":p,"jobNumber":jobNumber,"name":name,"deptId":deptId},
            dataType: "json",
            success: function (res) {
                ...
                $.each(res.list, function (i, v) {
                    ...
                    trObj.append($('<td><img width="50" height="50" src="/img/'+v.avatar+'"></img></td>'));
                    ...
                    trObj.append($("<td>" + v.entryDate + "</td>"));
                    trObj.append($('<a class="button border-main" href=" '+v.departmentId+'"><span class="icon-edit"></span> 修改</a >'));
                    trObj.append($('<a class="button border-red" href="/Doct/delete?docotrId='+(i+1)+'"><span class="icon-edit"></span>删除</a >'));
    ...
    function changesearch(){
        ...
        console.log($name,$jobNumber,$deptId);
        initDoclist(1,$name,$jobNumber,$deptId);
    }
