...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <button type="button" class="button border-yellow" onclick="window.location.href='dept/annc/anncadd.jsp'">
...
<%--                <td>${vs.index+1}</td>--%>
                ...
                <td>
                    <div class="button-group">
                        <a class="button border-main" href="/annctoEdit?announcementId=${pati.announcementId}">
                            <span class="icon-edit"></span> 修改</a>
                        <a class="button border-red" href="/anncdelete?announcementId=${pati.announcementId}" onclick="return del(1,1,1)">
