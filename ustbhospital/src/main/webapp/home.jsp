                ...
                <ul class="news_list">
                    <li>
                        <div class="news_pic col-lg-3 col-md-3 col-sm-4 col-xs-12">
                            <a href="dept/annc/annc1.jsp">
                                <img src="images/xb.png" />
                            </a>
                        </div>
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                            <a href="dept/annc/annc1.jsp" class="news_tit">${list.get(0).title}</a>
                    ...
                    <li>
                        <div class="news_pic col-lg-3 col-md-3 col-sm-4 col-xs-12">
                            <a href="dept/annc/annc2.jsp">
                                <img src="images/xb.png" />
                            </a>
                        </div>
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                            <a href="dept/annc/annc2.jsp" class="news_tit">${list.get(1).title}</a>
                    ...
                    <li>
                        <div class="news_pic col-lg-3 col-md-3 col-sm-4 col-xs-12">
                            <a href="dept/annc/annc3.jsp">
                                <img src="images/xb.png" />
                            </a>
                        </div>
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                            <a href="dept/annc/annc3.jsp" class="news_tit">${list.get(2).title}</a>
